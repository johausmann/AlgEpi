...
* TODO: add overview of TEPIC model
...
* Regions of enhancer associated histone marks
  + Histone ChIP-seq e.g. H3K27ac, H3K4me1, H3K122ac
...
* Segment window around gene in small bins and measure DNaseI signal

* Find groups of segments where combined DNaseI signal correlates with gene expression level
