...
* Target: quantify differences in DNA methylation between 2 sample groups based on CpGs and genomic regions of interest (e.g. found by MethylSeekR, annotation or promotor regions,...)

* LIMMA Model (easy integration of co-variates e.g. batch effects )
  + use methylation value (ratio of methylated against unmethylated)
