...
* ChIP-loop (ChIP-seq + 3c)
  ...
  + Pull down fragments with POI
  + Perform 3C

* ChIA-PET (ChIP-seq + Hi-C)
  + Enrichment of ligated fragments &rarr; Hi-C on subset
...
* Combined with gene expression data &rarr; A & B compartments
...
* Identification of enhancer locations
