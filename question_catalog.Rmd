...
* Identify associated peaks in far away regions with Hi-C window
  ...
  + Take peaks from HiC/Hi-ChIP loop window that overlaps Loop anchir windows
...
* Again: linear regression (INVOKE) &rarr; elastic net 
  + 6 features (at promoter and at loop windows): number of peaks, DNaseI signal, sum of peak lenghts wieghted by distance 
